...
const Slug = ({cart,addToCart,product,variants}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-3/4 sm:w-1/2 mx-auto  lg:h-auto  object-cover object-top rounded" src="https://m.media-amazon.com/images/I/913pxINoxNL._AC_UY879_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Avenger T-shirt</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Captain America.</h1>
        ...
        <div className="title-font font-medium  text-2xl text-gray-900 items-center  ">रु58.00</div>
       
        </div>

        <div className="flex " >
          <button className="flex ml-2 text-white bg-blue-500 border-0 py-2 px-5 sm:px-6 focus:outline-none hover:bg-blue-600 rounded">Buy Now</button>
          <button 
          onClick={()=>addToCart(slug,1,500,"captain americs t-shirt","Xl","red")}
          className="flex ml-2 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-center">Add to Cart</button>
...
export async function getServerSideProps(context) {
  ...
  let colorSizeSlug = {} // {red : {xl: {slug: "iron-man"}}}
