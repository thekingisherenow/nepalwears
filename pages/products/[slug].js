            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex " >
                <button
                  ...
                  className="flex ml-2 text-white bg-blue-500 border-0 py-2 px-5 sm:px-6 focus:outline-none hover:bg-blue-600 rounded">Buy Now</button>
                <button
                  onClick={() => addbuttonfuntions()}
