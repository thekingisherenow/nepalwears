      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-3/4 sm:w-1/2 mx-auto  lg:h-auto  object-cover object-top rounded" src={product.img} />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">{product.category}</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
                {product.title}({product.size}/{product.color})</h1>
                  ...
                  {listofcolors.map((colorItem) => {
                    return (<span key={colorItem}>
                      {Object.keys(variants).includes(colorItem)
                        ...
                        onClick={() => refreshVariant(colorItem,
                          Object.keys(variants[colorItem])[0])}
              ...
              <div className='flex p-5'>
                ...
                <div className="title-font font-medium  text-2xl text-gray-900 items-center  ">रु {product.price}</div>
              ...
              <div className="flex " >
                ...
                <button
                  onClick={() => addToCart(slug, 1, product.price, (product.title + "(" + product.size + "/"
